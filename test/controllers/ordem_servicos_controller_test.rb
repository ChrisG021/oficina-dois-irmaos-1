...
class OrdemServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should export pdf" do
    get ordem_servicos_url(format: :pdf)
    assert_response :success
  ...
  test "should create ordem_servico" do
    assert_difference("OrdemServico.count") do
      post ordem_servicos_url, params: { ordem_servico: { data_entrada: @ordem_servico.data_entrada, data_saida: @ordem_servico.data_saida, descricao: @ordem_servico.descricao, status: @ordem_servico.status, valor: @ordem_servico.valor, veiculo_id: @ordem_servico.veiculo_id } }
    end
  ...
  test "should update ordem_servico" do
    patch ordem_servico_url(@ordem_servico), params: { ordem_servico: { data_entrada: @ordem_servico.data_entrada, data_saida: @ordem_servico.data_saida, descricao: @ordem_servico.descricao, status: @ordem_servico.status, valor: @ordem_servico.valor, veiculo_id: @ordem_servico.veiculo_id } }
