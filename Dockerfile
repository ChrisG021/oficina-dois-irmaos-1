...
# docker build -t trabalho_constan_oficina .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name trabalho_constan_oficina trabalho_constan_oficina
